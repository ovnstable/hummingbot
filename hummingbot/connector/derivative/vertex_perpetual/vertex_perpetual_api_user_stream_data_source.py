...
class VertexPerpetualAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(
        ...
        super().__init__()
        self._auth: VertexPerpetualAuth = auth
        self._connector: VertexPerpetualDerivative = connector
